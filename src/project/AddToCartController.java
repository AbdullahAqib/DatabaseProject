...
//    private Button btn_addToList1;
    ...
    public void initialize(URL url, ResourceBundle rb) {
       ...
       price_col.setCellValueFactory(new PropertyValueFactory<Product,Float>("retailRate"));
...
//    }
    ...
    @FXML  
    private void addDataToOrderTable(ActionEvent event) {
        ...
        product.setRetailRate(Float.parseFloat(price.getText()));
